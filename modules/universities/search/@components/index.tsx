...
import {
  ...
  MultiselectHour,
  MultiselectRecruit,
} from "@/modules/jobs/@components/filter/MultiselectJobFilter";
import { IoSearchOutline } from "react-icons/io5";
import { MdCancel } from "react-icons/md";
import HandleRemoveFilter from "@/modules/uni-courses-with-filter/programs/search/@components/SelectiveFilterTop";
...
const attandanceOption = [
  { label: "On-Campus (323)", value: "IELTS" },
  { label: "Distance Learning (90)", value: "TOFEL" },
  { label: "Dermatological Medicine (10)", value: "PTE" },
];
      ...
      <div className=" flex gap-2 flex-wrap">
        {selectedSearch?.map((item: any, i: any) => {
          ...
          return item === null ? (
            ...
            splitItem?.map((item: any) => {
              return (
                <span className=" flex justify-center items-center gap-2 text-[12px] rounded-full p-2  bg-gradient-to-r from-indigo-500 to-purple-500 text-white  shadow-md  focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 ">
                  {item}
                  <MdCancel
                    onClick={() => {
          ...
          items={[
            {
              ...
              children: (
                <Checkbox.Group
                  name={`ContactType`}
                  options={[
                    { label: "Yes", value: "IELTS" },
                    { label: "No", value: "TOFEL" },
                  ]}
                  value={
