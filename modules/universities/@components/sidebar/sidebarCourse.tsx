...
const CourseInfo = ({ data }: any) => {
  return (
    <div className="">
      <h1 className="text-2xl font-bold mb-4">University Course Information</h1>
...
const SidebarProgramshero = ({ isShowActive = false, data }: propTypes) => {
...
export default SidebarProgramshero;
