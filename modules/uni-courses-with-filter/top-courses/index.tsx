...
import ProgramsFilter from "../programs/search/@components/Filter";
import UniCoursesSearchByNameTwo from "../@components/search-by-name/indexTwo";
import UniProgramCard from "../programs/search/@components/UniProgramCard";
...
const TopCourses = () => {
  ...
  const queryString = generateQueryString({
    ...queryParams,
    limit: "",
    countrySlug: countrySTR && countrySTR,
  ...
  useEffect(() => {
    router.push(`/top-course`, { scroll: false });
  }, [queryString, total]);
